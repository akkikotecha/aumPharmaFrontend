...
import Card from '@/components/blogCard/'; // Correct import for the Card component
...
const fromTheBlog: React.FC = () => {
  ...
  return (
    <div>
      <div className="flex items-center justify-between w-full p-0 md:container mt-12">
