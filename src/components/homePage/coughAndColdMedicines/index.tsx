...
import SwiperSelling from "@/components/homePage/SwiperSelling/Slider";

const CoughAndColdMedicinesSlider: React.FC = () => {
  const categories = [
      ...
      <div className="w-full px-0 mt-16">
        <div className="grid grid-cols-3 gap-4">
          <div className="col-span-2">
            <h1 className="shopByCategory">Cough & Cold Medicines </h1>
          </div>
...
export default CoughAndColdMedicinesSlider;
